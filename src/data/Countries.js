export const countries = [
  ...
  { code: "MM", label: "Myanmar (Birmania)", phone: "95" },
  ...
  { code: "RO", label: "Rumanía", phone: "40" },
  ...
  { code: "UM", label: "Islas menores alejadas de EE. UU.", phone: "1" },
  { code: "US", label: "Estados Unidos", phone: "1" },
  { code: "UY", label: "Uruguay", phone: "598" },
  { code: "UZ", label: "Uzbekistán", phone: "998" },
  { code: "VA", label: "Ciudad del Vaticano", phone: "39" },
  {
    code: "VC",
